...
const file_internal_domain_pb_user_proto_rawDesc = "" +
	"\n" +
	"\x1dinternal/domain/pb/user.proto\x12\x02pb\"\x81\x01\n" +
	...
	"\x05users\x18\x01 \x03(\v2\f.pb.UserDataR\x05users\x12\x14\n" +
...
var file_internal_domain_pb_user_proto_goTypes = []any{
	...
	(*GetUserListRequest)(nil),  // 2: pb.GetUserListRequest
	(*UserData)(nil),            // 3: pb.UserData
	(*GetUserListResponse)(nil), // 4: pb.GetUserListResponse
}
var file_internal_domain_pb_user_proto_depIdxs = []int32{
	3, // 0: pb.GetUserListResponse.users:type_name -> pb.UserData
